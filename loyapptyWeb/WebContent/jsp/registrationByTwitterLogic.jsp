...
<%
   ...
   //XML Tags
	...
	arg[8]="&twitter="+URLEncoder.encode(request.getParameter("TWho"));
	...
	try{
		...
		if(tags[0].equals("0006")){
			...
			result = call.callServlet(url.profileReviewGeneric("twitter", request.getParameter("TWho")));
			tags=xml.getTagsContent(result, tags);		
			if(tags[0].equals("0014")){
				...
				rest="&twTokenId="+request.getParameter("TToken")+"&twTokenSecret="+request.getParameter("TSecret");		
